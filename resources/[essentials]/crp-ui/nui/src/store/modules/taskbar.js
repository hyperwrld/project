...
const state = () => ({
    ...
    skillbarInfo: {
        status: false, left: 0, skillbarWidth: 0, mainInterval: null, timerInterval: null, counter: 0,
        rectangle: {
            width: 0, left: 0
        },
        difficulty: {
...
const mutations = {
    ...
    setSkillbar(state, data) {
        ...
        //     case 1:
        //         state.skillbarInfo.difficulty.percentage = 0.18, state.skillbarInfo.difficulty.movement = 0.10;
        ...
        //         break;
        //     case 2:
        //         state.skillbarInfo.difficulty.percentage = 0.35, state.skillbarInfo.difficulty.movement = 0.20;
        ...
        //         break;
        //     case 3:
        //         state.skillbarInfo.difficulty.percentage = 0.50, state.skillbarInfo.difficulty.movement = 0.40;
        ...
        // /car 300 0.5 0.1 0.2 15 5 (3)

        state.skillbarInfo.difficulty.percentage = data.maxPercentage, state.skillbarInfo.difficulty.movement = data.playerPercentage;
        state.skillbarInfo.rectangle.width = state.skillbarInfo.skillbarWidth * 0.10, state.skillbarInfo.rectangle.left = Math.random() * (((state.skillbarInfo.skillbarWidth - state.skillbarInfo.rectangle.width) - 15) - 15) + 15;

        state.skillbarInfo.mainInterval = setInterval(() => {
            const randomValue = (Math.random() * (state.skillbarInfo.difficulty.percentage - 0.1) + 0.1) * state.skillbarInfo.rectangle.width;
        ...
        state.skillbarInfo.timerInterval = setInterval(() => {
            ...
            if (timer >= data.maxTime) {
                this.commit('taskbar/stopIntervals');
            }
        }, 1000);
    },
    // setSkillbar(state, data) {
