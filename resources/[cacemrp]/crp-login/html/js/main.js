...
function showSelection(data) {
    ...
    if (Array.isArray(data.playercharacters) && data.playercharacters.length) {
        $.each(data.playercharacters, function(index, char){
            ...
            characterinfo.innerHTML   = '</br><b>Sexo:</b></br>' + char.sex + '</br></br><b>Data de Nascimento:</b></br>' + char.dateofbirth + '</br></br><b>Profissão:</b></br>' + char.job + '</br></br><b>Dinheiro:</b></br>' + char.money + ' €</br></br><b>Banco:</b></br>' + char.bank + ' €</br></br><b>História:</b></br>' + char.history;    
